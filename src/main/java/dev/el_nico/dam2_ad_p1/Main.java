package dev.el_nico.dam2_ad_p1;

import java.sql.SQLException;
import java.util.List;
import java.util.Optional;

import dev.el_nico.dam2_ad_p1.dao.sql.ConexionJardineria;
import dev.el_nico.dam2_ad_p1.excepciones.ExcepcionCodigoYaExistente;
import dev.el_nico.dam2_ad_p1.excepciones.ExcepcionDatoNoValido;
import dev.el_nico.dam2_ad_p1.excepciones.ExcepcionFormatoIncorrecto;
import dev.el_nico.dam2_ad_p1.modelo.Cliente;
import dev.el_nico.dam2_ad_p1.modelo.Producto;
...
public class Main {
    ...
    private static void pedirCodigoYEditarProducto(ConexionJardineria c) {
        ...
        } while (error = optproducto.isEmpty());
    ...
    private static void pedirCodigoYMostrarCliente(ConexionJardineria c) {
        ...
        c.clientes().uno(codigo).ifPresentOrElse(
            cli -> System.out.println(cli), 
    ...
    private static String pedirString(String msj, boolean puedeEstarVacio) {
        ...
        } while (puedeEstarVacio ? false : (error = s.isBlank()));
